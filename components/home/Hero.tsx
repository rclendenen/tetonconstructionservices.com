    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          alt="Mansfield Texas suburban home"
          fill
        ...
        <div className="max-w-4xl">
          <div className="mb-6">
            <a
              ...
              className="inline-block px-4 py-2 bg-sunshine-500/20 backdrop-blur-sm text-sunshine-100 rounded-full text-sm font-semibold border border-sunshine-400/40 hover:bg-sunshine-500/30 transition-colors duration-200"
            >
